...
$cities = json_decode(IndoCPA($TOKEN, "https://auth.indocpa.me/hotel/?city=$city"));
...
<head>
    ...
    <meta name="keywords" content="travel, <?php echo $city.' Hotels, discount room rates, book online, reservations hotel, room selection, special offers, popular hotels, acommodation, accomodation, acomodation, accommodation';?>" />
    <meta name="description" content="">
    <meta name="author" content="IndoCPA">
	<meta name="robots" content="index , follow">
    <title>Hotels Found in <?=$city; ?></title>
...
<?php
	foreach ($cities->data as $c) { ?>
            	...
            	<a class="tooltip_flip tooltip-effect-1" href="javascript:void(0);">+<span class="tooltip-content-flip"><span class="tooltip-back">Add to wishlist</span></span></a>
                    	...
                    	<div class="img_list"><a href="hotel.php?id=<?=$c->data->hotel_id;?>"><div class="ribbon popular" ></div><img src="<?=$c->hotel->images[1]->url;?>" alt="">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <h3><strong><?=$c->data->hotel_name ?></strong> Hotel</h3>
					...
					<div class="col-lg-2 col-md-2 col-sm-2">
                    	<div class="price_list"><div><sup>$</sup><?=$c->data->rates_from;?>*
<!--                     	<span class="normal_price_list">$99</span> -->
                    	<small >*From/Per night</small>
                        <p><a href="hotel.php?id=<?=$c->data->hotel_id;?>" class="btn_1">Details</a></p>
                        </div>
                        </div>
                    </div>
                    </div>
